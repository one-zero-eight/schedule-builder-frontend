...
export default function LessonCard({ lesson, onIgnore, mode = 'ignore' }: LessonCardProps) {
  ...
  const buttonClass = isRestoreMode 
    ? "text-[10px] w-4 h-4 bg-green-600 hover:bg-green-700 text-white rounded-full transition-colors right-1 flex items-center justify-center"
    : "text-[10px] w-4 h-4 bg-red-600 hover:bg-red-700 text-white rounded-full transition-colors right-1 flex items-center justify-center";
